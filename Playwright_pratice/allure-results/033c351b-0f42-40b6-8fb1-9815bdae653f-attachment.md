...
- Name: automation\TestCase10.test.ts >> subscribe
- Location: tests\automation\TestCase10.test.ts:3:5
...
Locator: locator('#success-subscribe')
Timeout: 5000ms
- Expected substring  - 1
+ Received string     + 3

- You have been succfully subscribed!
+
...
Call log:
  ...
  - waiting for locator('#success-subscribe')
    7 × locator resolved to <div id="success-subscribe" class="col-md-9 form-group">…</div>
      - unexpected value "
							You have been successfully subscribed!
						"
    6 × locator resolved to <div id="success-subscribe" class="col-md-9 form-group hide">…</div>
      - unexpected value "
							You have been successfully subscribed!
						"
...
```ts
  ...
  10 | 
  11 |     await page.goto("https://automationexercise.com/")
  12 |     await page.reload()
  13 | 
  14 |     let sub = page.getByText('Subscription');
  15 |     await sub.scrollIntoViewIfNeeded();
  16 | 
  17 |     await page.locator("#susbscribe_email").fill("john@gmail.com")
  18 |     await page.locator("#subscribe").click()
  19 |     let subText = page.locator("#success-subscribe")
  20 |     console.log("the subscribe text is",subText.textContent())
  21 | 
> 22 |         await expect(subText).toContainText('You have been succfully subscribed!')
     |                               ^ Error: expect(locator).toContainText(expected) failed
  23 | 
