          ...
          - generic [ref=e60]:
            ...
            - generic [ref=e63]:
              - generic [ref=e65]:
                ...
                - textbox "Please enter first value" [ref=e67]: "2"
                - paragraph [ref=e68]: Enter second value
                - textbox "Please enter second value" [active] [ref=e69]: "2"
  ...
  - generic [ref=e389] [cursor=pointer]:
    - generic [ref=e390]:
      - generic [ref=e392]:
        ...
        - img [ref=e399]
      - generic [ref=e401]:
        - generic [ref=e402]: Ask Me Anything
        - generic [ref=e403]: Ask Me Anything
    - generic [ref=e406]:
      - button [ref=e407]:
        - img [ref=e410]
      - button "Talk to agent" [ref=e412]:
        - generic [ref=e417]: Talk to agent
  - button "Hello, have a question? Let’s chat." [ref=e418] [cursor=pointer]:
    - img [ref=e420]
  - iframe [ref=e422]:
...
> 23 |     await page.waitForTimeout(4000);
     |                ^ Error: page.waitForTimeout: Test timeout of 30000ms exceeded.
  24 |     
  25 |     let inp1= val1.inputValue()
  26 | 
  27 |     let inp2=val2.inputValue()
  28 |     
  29 |    // const res2 = (inp1+inp2).toString();
  30 |     let res =await page.locator('//p[@id="addmessage"]').textContent()
  31 | 
  32 |     console.log("value1 ", await inp1)
  33 |     console.log("value2 ", await inp2)
  34 |     expect(res).toBe("4")
  35 |     console.log(res)
  36 | 
  37 | })
```