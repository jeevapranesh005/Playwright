...
```ts
  ...
  17 |     console.log(url)
  18 | 
  19 |     let beforeText= await page.getByPlaceholder("Please enter your Message").getAttribute('placeholder')
  20 |     console.log(beforeText)
  21 |     await page.getByPlaceholder("Please enter your Message").fill('Jeeva')
  22 |     
  23 | 
  24 | 
  ...
  27 | 
  28 |     const output = await page.locator("#message");
> 29 |     await expect(output).toContainText('Jeeva')
     |                          ^ Error: expect(locator).toContainText(expected) failed
