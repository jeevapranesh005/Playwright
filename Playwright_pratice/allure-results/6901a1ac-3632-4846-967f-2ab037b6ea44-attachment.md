...
- Location: tests\automation\alerts.test.ts:4:5
...
Call log:
  - waiting for locator('//button[@fdprocessedid=\'cru4jj\']')
...
```ts
  1  | //button[@fdprocessedid="ajjt7e"]
  2  | import{test,expect} from '@playwright/test'
  3  | 
  4  | test('simple alert' , async({page})=>{
  5  | 
  6  |     await page.goto("https://www.testmuai.com/selenium-playground/javascript-alert-box-demo/")
  7  | 
  8  |     let simple = page.locator("//button[@class='btn btn-dark my-30 mx-10 hover:bg-lambda-900 hover:border-lambda-900']")
  9  |    
  10 |     page.on('dialog',async dialog=>{
  11 |         dialog.accept()
  12 |     })
  13 |     await simple.click()
  14 |     let simple1 = page.locator("//button[@fdprocessedid='cru4jj']")
> 15 |     await simple1.click()
     |                   ^ Error: locator.click: Test timeout of 60000ms exceeded.
  16 | 
  17 |     
  18 |     console.log("alert handled")
  19 | 
  20 | 
  21 | 
  22 | 
