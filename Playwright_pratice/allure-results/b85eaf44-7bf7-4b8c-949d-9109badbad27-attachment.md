  ...
  - generic [ref=e380] [cursor=pointer]:
    - generic [ref=e381]:
      - generic [ref=e383]:
        ...
        - img [ref=e390]
      - generic [ref=e392]:
        - generic [ref=e395]: Ask Me Anything
        - generic: Ask Me Anything
    - generic [ref=e398]:
      - button [ref=e399]:
        - img [ref=e402]
      - button "Talk to agent" [ref=e404]:
        - generic [ref=e409]: Talk to agent
  - iframe [ref=e410]:
...
```ts
  ...
  6  | 
  7  |     let simple = page.locator("//button[@class='btn btn-dark my-30 mx-10 hover:bg-lambda-900 hover:border-lambda-900']")
  8  |    
  9  |     page.on('dialog',async dialog=>{
  10 |         dialog.accept()
  11 |         console.log(dialog.message())
  12 |     })
  13 |     await simple.click()
  14 | 
  15 | 
...
> 17 |         dialog.dismiss()
  ...
  20 | 
  21 | 
  22 |     let confomalert=  page.locator("//button[@class='btn btn-dark mx-10 hover:bg-lambda-900 hover:border-lambda-900']").nth(0)
  23 |     await confomalert.click()
  24 | 
  25 |     let text = page.locator("//p[@id='confirm-demo']").textContent()
  26 |     console.log(await text)
  27 |    
  28 | 
  29 |     
  30 |     console.log("alert handled")
  31 | 
  32 | 
  33 | 
  34 | 
