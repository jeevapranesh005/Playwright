...
```
Error: page.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//button[@onclick='logIn()'']' is not a valid XPath expression.
