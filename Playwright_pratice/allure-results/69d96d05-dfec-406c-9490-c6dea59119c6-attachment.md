...
- Name: tutorialNinja.spec.ts >> login
- Location: tests\tutorialNinja.spec.ts:8:5
...
Call log:
  - waiting for locator('//ul//a[text()=\'Logn\']')
...
```ts
  ...
  9  | 
  10 |    
  11 |     await page.click("//span[text()='My Account']")
> 12 |     await page.click("//ul//a[text()='Logn']")
     |                ^ Error: page.click: Test timeout of 30000ms exceeded.
  13 |     await page.fill("#input-email",process.env.UNAME!)
  14 |     await page.fill("#input-password",process.env.PASS!)
  15 |     await page.click("//input[@value='Login']")
  16 |     
  17 | })
  18 | 
```